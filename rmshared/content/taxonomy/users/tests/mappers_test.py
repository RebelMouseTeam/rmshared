...
class TestMappers:
    ...
    CORE_FILTERS = [
        core.filters.AnyLabel[core.labels.Label](labels=(
            ...
            core.labels.Value(field=core.fields.System(name='user-owner'), value=234),
            core.labels.Value(field=core.fields.System(name='user-status'), value='inactive(banned=true)'),
            core.labels.Value(field=core.fields.System(name='user-status'), value='inactive(banned=false)'),
        ...
        core.filters.NoLabels[core.labels.Label](labels=(
            ...
            core.labels.Value(field=core.fields.System(name='user-status'), value='pending'),
            core.labels.Value(field=core.fields.System(name='user-status'), value='active'),
