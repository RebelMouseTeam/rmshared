...
class TestMappers:
    ...
    SECTIONS_FILTERS = [
        core.filters.AnyLabel(labels=(
            ...
            labels.ReadOnly(),
            # TODO: consider `labels.ParentSlug(value='parent-slug-1')`,
            # TODO: consider `labels.AncestorSlug(value='ancestor-slug-1')`,
    ...
    CORE_FILTERS = [
        core.filters.AnyLabel[core.labels.Label](labels=(
            ...
            # TODO: consider `core.labels.Value(field=core.fields.System(name='section-parent-slug'), value='parent-slug-1')`,
            # TODO: consider `core.labels.Value(field=core.fields.System(name='section-ancestor-slug'), value='ancestor-slug-1')`,
