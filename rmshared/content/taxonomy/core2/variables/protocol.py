...
from rmshared.content.taxonomy.core2 import protocol
from rmshared.content.taxonomy.core2.variables import Argument
from rmshared.content.taxonomy.core2.variables import Reference
...
class Factory:
    ...
    def make_filters(self, labels_: base_protocols.ILabels, ranges_: base_protocols.IRanges) -> base_protocols.IFilters[operators.Operator[filters.Filter]]:
        ...
        return base_protocols.fallbacks.Filters(delegate=instance, fallback=self.ReturnFiltersFallback(delegate))
    ...
    def make_ranges(self, fields_: base_protocols.IFields, values_: base_protocols.IValues) -> base_protocols.IRanges[operators.Operator[ranges.Range]]:
        ...
        return base_protocols.fallbacks.Ranges(delegate=instance, fallback=self.ReturnRangesFallback(delegate))
    ...
    class ReturnFiltersFallback(base_protocols.IFilters[operators.Return[filters.Filter]]):
    ...
    class ReturnLabelsFallback(base_protocols.ILabels[operators.Return[labels.Label]]):
        ...
        def jsonify_label(self, label: operators.Return[labels.Label]):
    ...
    class ReturnRangesFallback(base_protocols.IRanges[operators.Return[ranges.Range]]):
    ...
    class Operators:
        ...
        def make_switch(self, data: Mapping[str, Any], make_case: Callable[[Any], T]) -> operators.Switch[T]:
            ...
            return operators.Switch[T](
                ...
                cases=self.variables.make_cases(data['$switch']['$cases'], make_return),
            )
        ...
        def jsonify_switch(self, operator: operators.Switch[T], jsonify_case: Callable[[T], Any]) -> Mapping[str, Any]:
            ...
            return {'$switch': {
                ...
                '$cases': self.variables.jsonify_cases(operator.cases, jsonify_operator),
            }}
    ...
    class Variables:
        ...
        @staticmethod
        def jsonify_variable(ref, index):
