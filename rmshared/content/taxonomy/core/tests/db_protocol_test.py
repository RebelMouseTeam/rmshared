...
class TestProtocol:
    ...
    FILTERS_DATA = tuple([
        {'any_label': [
            {'value': {'field': {'type': 'system', 'info': {'name': 'post-id'}}, 'value': 123}},
            {'value': {'field': {'type': 'system', 'info': {'name': 'post-type'}}, 'value': 'how-to'}},
            {'value': {'field': {'type': 'system', 'info': {'name': 'post-status'}}, 'value': 'published-to-community(demoted=true)'}},
        ]},
        {'no_labels': [
            {'badge': {'field': {'type': 'system', 'info': {'name': 'private-post'}}}},
            {'empty': {'field': {'type': 'custom', 'info': {'name': 'custom-post-field', 'path': 'path.to.field'}}}},
        ]},
        {'any_range': [
            {'field': {'type': 'system', 'info': {'name': 'post-modified-at'}}, 'min': NOW - 100, 'max': NOW + 100},
        ]},
        {'no_ranges': [
            {'field': {'type': 'system', 'info': {'name': 'post-scheduled-at'}}, 'min': NOW - 200},
            {'field': {'type': 'system', 'info': {'name': 'post-published-at'}}, 'max': NOW + 300},
        ]},
    ])
