...
from rmshared.content.taxonomy.core.server.protocol.protocol import Protocol
...
class TestServerProtocol:
    ...
    def test_it_should_parse_filters(self, protocol: Protocol):
        filters_ = protocol.make_filters(data=[
            {'any_label': [
    ...
    def test_it_should_parse_order(self, protocol: Protocol):
        ...
        assert order == Order(field=Field('post-modified-at'), reverse=False)
